...
import { UpdateBoardOutput } from './dtos/board/update-board.dto';
...
export class BoardsService {
  ...
  async showBoard(boardId): Promise<ShowBoardOutput> {
    try {
  ...
  async showBoards(page): Promise<ShowBoardsOutput> {
    try {
  ...
  async searchedBoards(selectedItem, page) {
    try {
